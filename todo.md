- [x] InteractivePrompt: screen contents can get messed up when hitting backspace repeatedly
...
- [x] repl sometimes needs you to press Ctrl+C more times than it should
