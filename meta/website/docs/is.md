...
See also [types](./types.md#types-object) (which contains [TypeValidator](./types.md#typevalidator-type)s that can be
used by `is`) and [assert.type](./assert.md#asserttype-function-property) (which throws an error instead of
returning a boolean).
...
Alias to [is](./is.md#is-function), for when using the Civet language, because `is` is a
