...
POSIX open flag, used in [open](./os.md#quickjsosopen-exported-function).
...
They are created by native functions like [CreateProcess](./os.md#quickjsoscreateprocess-exported-value).
