...
For instance, `process.env` is a getter that returns [env](./env.md#env-object), and
`process.argv` is a getter that returns [scriptArgs](./cmdline.md#scriptargs-value).
