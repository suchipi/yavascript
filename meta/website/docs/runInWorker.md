...
Run the following function inside of a [Worker](./worker.md) (ie another thread).
...
If you need to access imports inside the worker, use [require](./modulesys.md#requirefunction-call-signature).
