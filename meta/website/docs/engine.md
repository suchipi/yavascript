...
The main module can be set via [setMainModule](./engine.md#quickjsenginesetmainmodule-exported-function).
...
A single stack frame captured by [getStackFrames](./engine.md#quickjsenginegetstackframes-exported-function).
...
Capture the current call stack as an array of [StackFrame](./engine.md#quickjsenginestackframe-exported-type) objects,
...
Frames beyond a `backtraceBarrier` (see [evalScript](./engine.md#quickjsengineevalscript-exported-function)) are not
...
backtrace is built. See [setStackFrameMapper](./engine.md#quickjsenginesetstackframemapper-exported-function) for details.
...
[setStackFrameMapper](./engine.md#quickjsenginesetstackframemapper-exported-function), or `null` if none is registered.
...
This is a parallel formatter to [inspect](./inspect.md#inspect-inspectfunction) — it uses the engine's
