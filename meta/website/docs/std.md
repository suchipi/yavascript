...
Constant for [FILE.seek](./std.md#fileseek-method). Declares that pointer offset should be relative to the beginning of the file. See also libc `fseek()`.
...
Constant for [FILE.seek](./std.md#fileseek-method). Declares that the offset should be relative to the current position of the FILE handle. See also libc `fseek()`.
...
Constant for [FILE.seek](./std.md#fileseek-method). Declares that the offset should be relative to the end of the file. See also libc `fseek()`.
...
Constant for [FILE.setvbuf](./std.md#filesetvbuf-method). Declares that the buffer mode should be 'full buffering'.
...
Constant for [FILE.setvbuf](./std.md#filesetvbuf-method). Declares that the buffer mode should be 'line buffering'.
...
Constant for [FILE.setvbuf](./std.md#filesetvbuf-method). Declares that the buffer mode should be 'no buffering'.
...
The default buffer size for a buffered FILE. Useful for passing into [FILE.setvbuf](./std.md#filesetvbuf-method).
...
The type of the object returned by [getpwuid](./std.md#quickjsstdgetpwuid-exported-function).
