...
- `@param` _options_ — Options; see [BaseExecOptions](./exec.md#baseexecoptions-type)
...
using the same logic that [exec](./exec.md#exec-interface) and [ChildProcess](./ChildProcess.md#childprocess-interface) use.
...
For more info, see [exec](./exec.md#exec-interface).
