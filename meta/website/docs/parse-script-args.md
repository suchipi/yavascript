...
meet your needs, you can parse the [scriptArgs](./cmdline.md#scriptargs-value) global manually.
...
- `@returns` A [ParseScriptArgsResult](./parse-script-args.md#parsescriptargsresult-interface), which is an object with three
...
The return type of [parseScriptArgs](./parse-script-args.md#parsescriptargs-function).
...
`flags` property of the [ParseScriptArgsResult](./parse-script-args.md#parsescriptargsresult-interface).
...
to [parseScriptArgs](./parse-script-args.md#parsescriptargs-function).
